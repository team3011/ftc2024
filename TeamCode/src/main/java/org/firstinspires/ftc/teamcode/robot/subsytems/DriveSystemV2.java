...
public class DriveSystemV2 {
    ...
    public DriveSystemV2(DcMotorEx fL, DcMotorEx fR, DcMotorEx bL, DcMotorEx bR, AHRS n, Encoder parallel, Encoder perpindicular) {
        this.frontLeft = fL;
        this.frontRight = fR;
        this.backLeft = bL;
        this.backRight = bR;
    ...
    public double figureOutWhatIsShorter() {
        double result;
        double reading = Math.toRadians(this.navX.getYaw());
